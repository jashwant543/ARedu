...
RotateSlider = GameObject.Find("RotateSlider").GetComponent<Slider>(); 
    ...
    void Update()
    {
        transform.localEulerAngles = new Vector3(0.0f, RotateSlider.value,0f);
        jashh.transform.localScale = new Vector3(ScaleSlider.value, ScaleSlider.value, ScaleSlider.value);
       jashh. transform.localScale = new Vector3(ScaleSlider.value, ScaleSlider.value, ScaleSlider.value);
    }
    //private void OnGUI()
    //{
